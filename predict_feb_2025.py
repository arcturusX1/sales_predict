...
# Save the model
model.save_model("catboost_jan_2025.cbm")
...
print("Predicted Monthly Sales for February 2025:")
print(monthly_sales)

# Save predictions
pred_df.to_csv('february_2025_predictions.csv', index=False)
monthly_sales.to_csv('february_2025_monthly_sales.csv', index=False)

# Plot the chart
plt.figure(figsize=(14, 8))
plt.bar(monthly_sales['Outlet'], monthly_sales['Predicted February 2025 Sales'], color='skyblue')
plt.xticks(rotation=45, ha='right')
plt.xlabel('Outlet')
plt.ylabel('Predicted February 2025 Sales')
plt.title('Predicted February 2025 Sales per Outlet')
plt.tight_layout()
plt.savefig('february_2025_sales_chart.png', dpi=300, bbox_inches='tight')
plt.show()